...
export const MacbookScroll = ({
  ...
  const translate = useTransform(scrollYProgress, [0.07, isMobile ? 0.7 : 0.7], [0, isMobile ? 600 : 800]);
  ...
  return (
    <div
      ref={ref}
      className="flex min-h-[140vh] sm:min-h-[120vh] md:min-h-[150vh] shrink-0 scale-[0.65] transform flex-col items-center justify-start pt-0 pb-0 [perspective:800px] sm:scale-75 md:scale-100 -mt-40 sm:-mt-24 md:-mt-12 relative overflow-hidden"
    >
      <motion.h2
        style={{
